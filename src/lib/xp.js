...
export const LEVELS = [
  ...
  { level: 2,  xpRequired: 500,  title: 'Rising' },
  { level: 3,  xpRequired: 1000,  title: 'Grinder' },
  { level: 4,  xpRequired: 2000,  title: 'Hustler' },
  { level: 5,  xpRequired: 4000,  title: 'Boss' },
  { level: 6,  xpRequired: 6000, title: 'Idan' },
  { level: 7,  xpRequired: 8000, title: 'Seniorman' },
  { level: 8,  xpRequired: 10000, title: 'Oga Boss' },
  { level: 9,  xpRequired: 12500, title: 'Chairman' },
  { level: 10, xpRequired: 15000, title: 'Agba' },
  { level: 11, xpRequired: 20000, title: 'Odogwu' },
  {level: 12, xpRequired: 25000, title: 'Don' },
  {level: 13, xpRequired: 30000, title: 'Baba Nla' },
  { level: 14, xpRequired: 37500, title: 'Legend' },
  { level: 15, xpRequired: 50000, title: 'Final Boss' },
]
