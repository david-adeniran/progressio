...
export default function AddGoalModal({ onClose, onAdd, categories }) {
  ...
  const [selectedUnit, setSelectedUnit] = useState(
    UNIT_CATEGORIES[0].units[0].symbol,
  );
  const [customUnit, setCustomUnit] = useState("");

  const currentCat = UNIT_CATEGORIES.find((c) => c.label === unitCategory);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g. Save up for rent"
              required
              autoFocus
            />
          </div>
          ...
          {trackingType === "numeric" && (
            <>
              ...
              <div className="form-group">
                ...
                >
                  Frequency is locked after creation — daily goals stay daily,
                  weekly stay weekly, etc.
                </p>
              </div>
            </>
          )}
